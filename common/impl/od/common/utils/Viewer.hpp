...
namespace od {
	...
	void Viewer::render(shared_ptr<pcl::PointCloud<PointT> > to_display, const std::string & cloud_name, bool colored)
	{
	...
	template<typename PointT>
	void Viewer::render(shared_ptr<pcl::PointCloud<PointT> > to_display, 
	...
	template<typename PointT>
	void Viewer::render(shared_ptr<ScenePointCloud<PointT> > to_display, const std::string & cloud_name, bool colored)
	{
		render(to_display->getPointCloud(), cloud_name, colored);
	}

	template<typename PointT>
	void Viewer::render(const ScenePointCloud<PointT> & to_display, const std::string & cloud_name, bool colored)
	{
		render(to_display.getPointCloud(), cloud_name, colored);
	}

	template<typename PointT>
	void Viewer::update(shared_ptr<pcl::PointCloud<PointT> > to_display, const std::string & cloud_name, bool colored)
	{
		if(status_ != POINTCLOUD){
	...
	template<typename PointT>
	void Viewer::update(shared_ptr<ScenePointCloud<PointT> > to_display, const std::string & cloud_name, bool colored)
	{
		update(to_display->getPointCloud(), cloud_name, colored);
	}

	template<typename PointT>
	void Viewer::update(const ScenePointCloud<PointT> & to_display, const std::string & cloud_name, bool colored)
	{
		update(to_display.getPointCloud(), cloud_name, colored);
	}
